...
public abstract class AbstractCqlType implements CqlField.CqlType
{
                                    ...
                                    long deletionTime)
    {
        ...
        // C* 6.0 made DeletionTime abstract; instances come from the build factory and localDeletionTime is a long
