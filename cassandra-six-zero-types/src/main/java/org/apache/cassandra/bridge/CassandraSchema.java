...
public final class CassandraSchema
{
     ...
     */
    public static void update(Consumer<SchemaProvider> updater)
    {
     ...
     */
    public static <T> T apply(Function<SchemaProvider, T> updater)
    {
        synchronized (Schema.instance)
        {
    ...
    public static boolean keyspaceExists(SchemaProvider schema, String keyspace)
    {
        return getKeyspace(schema, keyspace).isPresent();
    }

    public static boolean tableExists(SchemaProvider schema, String keyspace, String table)
    {
        return getTable(schema, keyspace, table).isPresent();
    }

    public static Optional<Keyspace> getKeyspace(SchemaProvider schema, String keyspace)
    {
        return Optional.ofNullable(schema.getKeyspaceInstance(keyspace));
    }

    public static Optional<KeyspaceMetadata> getKeyspaceMetadata(SchemaProvider schema, String keyspace)
    {
    ...
    public static Optional<TableMetadata> getTable(SchemaProvider schema, String keyspace, String table)
    {
        return Optional.ofNullable(schema.getTableMetadata(keyspace, table));
    }

    public static boolean has(SchemaProvider schema, CqlTable cqlTable)
    {
        return has(schema, cqlTable.keyspace(), cqlTable.table());
    }

    public static boolean has(SchemaProvider schema, String keyspace, String table)
    {
    ...
    public static boolean isCdcEnabled(SchemaProvider schema, CqlTable cqlTable)
    {
    ...
    public static boolean isCdcEnabled(SchemaProvider schema, String keyspace, String table)
    {
    ...
    public static Map<String, Set<String>> cdcEnabledTables(SchemaProvider schema)
    {
    ...
    public static Set<String> cdcEnabledTables(SchemaProvider schema, String keyspace)
    {
    ...
    public static void maybeUpdateSchema(SchemaProvider schema,
                                         Partitioner partitioner,
                                         CqlTable cqlTable,
                                         @Nullable UUID tableId,
                                         boolean enableCdc)
    ...
    public static void updateCdcSchema(@NotNull SchemaProvider schema,
    ...
    public static void enableCdc(SchemaProvider schema, CqlTable cqlTable)
    {
        enableCdc(schema, cqlTable.keyspace(), cqlTable.table());
    }

    public static void enableCdc(SchemaProvider schema,
                                 String keyspace,
                                 String table)
    {
    ...
    public static void disableCdc(SchemaProvider schema, CqlTable cqlTable)
    {
        disableCdc(schema, cqlTable.keyspace(), cqlTable.table());
    }

    public static void disableCdc(SchemaProvider schema,
                                  String keyspace,
                                  String table)
    {
    ...
    public static void updateCdc(SchemaProvider schema,
                                 String keyspace,
                                 String table,
                                 boolean enableCdc)
    {
